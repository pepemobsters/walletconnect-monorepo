...
internal interface UniffiLib : Library {
    ...
    fun uniffi_uniffi_yttrium_fn_clone_accountclient(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_uniffi_yttrium_fn_free_accountclient(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_uniffi_yttrium_fn_constructor_accountclient_new(`config`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_uniffi_yttrium_fn_method_accountclient_chain_id(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Long
    fun uniffi_uniffi_yttrium_fn_method_accountclient_do_send_transactions(`ptr`: Pointer,`signatures`: RustBuffer.ByValue,`doSendTransactionParams`: RustBuffer.ByValue,
    ): Long
    fun uniffi_uniffi_yttrium_fn_method_accountclient_get_address(`ptr`: Pointer,
    ): Long
    fun uniffi_uniffi_yttrium_fn_method_accountclient_prepare_send_transactions(`ptr`: Pointer,`transactions`: RustBuffer.ByValue,
    ): Long
    fun uniffi_uniffi_yttrium_fn_method_accountclient_send_transactions(`ptr`: Pointer,`transactions`: RustBuffer.ByValue,
    ): Long
    fun uniffi_uniffi_yttrium_fn_method_accountclient_sign_message_with_mnemonic(`ptr`: Pointer,`message`: RustBuffer.ByValue,`mnemonic`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_uniffi_yttrium_fn_method_accountclient_wait_for_user_operation_receipt(`ptr`: Pointer,`userOperationHash`: RustBuffer.ByValue,
    ): Long
    ...
    fun uniffi_uniffi_yttrium_checksum_method_accountclient_do_send_transactions(
    ): Short
    fun uniffi_uniffi_yttrium_checksum_method_accountclient_get_address(
    ): Short
    fun uniffi_uniffi_yttrium_checksum_method_accountclient_prepare_send_transactions(
    ): Short
    fun uniffi_uniffi_yttrium_checksum_method_accountclient_send_transactions(
    ): Short
    fun uniffi_uniffi_yttrium_checksum_method_accountclient_sign_message_with_mnemonic(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_chain_id() != 13869.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_do_send_transactions() != 43780.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_get_address() != 31433.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_prepare_send_transactions() != 36285.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_send_transactions() != 2958.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_sign_message_with_mnemonic() != 63629.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_wait_for_user_operation_receipt() != 27843.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_uniffi_yttrium_checksum_constructor_accountclient_new() != 42006.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
public interface AccountClientInterface {
    ...
    suspend fun `prepareSendTransactions`(`transactions`: List<Transaction>): PreparedSendTransaction
...
open class AccountClient: Disposable, AutoCloseable, AccountClientInterface {
    ...
    override suspend fun `doSendTransactions`(`signatures`: List<OwnerSignature>, `doSendTransactionParams`: kotlin.String) : kotlin.String {
        ...
        callWithPointer { thisPtr ->
            UniffiLib.INSTANCE.uniffi_uniffi_yttrium_fn_method_accountclient_do_send_transactions(
                thisPtr,
    ...
    @Throws(Exception::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `prepareSendTransactions`(`transactions`: List<Transaction>) : PreparedSendTransaction {
        return uniffiRustCallAsync(
        callWithPointer { thisPtr ->
            UniffiLib.INSTANCE.uniffi_uniffi_yttrium_fn_method_accountclient_prepare_send_transactions(
                thisPtr,
    ...
    @Throws(Exception::class)override fun `signMessageWithMnemonic`(`message`: kotlin.String, `mnemonic`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithPointer {
    uniffiRustCallWithError(Exception) { _status ->
    UniffiLib.INSTANCE.uniffi_uniffi_yttrium_fn_method_accountclient_sign_message_with_mnemonic(
